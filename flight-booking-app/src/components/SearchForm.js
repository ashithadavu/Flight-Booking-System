...
function Form() {
    ...
    return (
        <Box component={Paper} elevation={5} sx={{ backgroundColor: 'transparent', borderRadius: 2,width:'50%',marginTop:'7%',marginLeft:"20%" }}>
            <form onSubmit={handleSubmit} style={{"marginTop":"5em"}}>
                <Stack sx={{ m: 2 }} direction='row' spacing={2}>
                    ...
                    <TextField
                        ...
                        onChange={handleChange}
                    />
                    <Button variant='contained' type='submit' style={{"width":"19em"}}>Search Flight</Button>
                </Stack>
            </form>
        </Box>
    )
