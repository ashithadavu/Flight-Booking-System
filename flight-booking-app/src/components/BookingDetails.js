...
export default function GetBookingDetails() {
    ...
    const url = "http://localhost:8080/booking/getAll"
                                ...
                                <TableBody>
                                    {booking.map((book) => (
                                        <StyledTableRow>
                                            ...
                                            <StyledTableCell>{book.requiredNumberOfSeats}</StyledTableCell>
                                            <StyledTableCell>{book.flightInfo.id}</StyledTableCell>
                                            <StyledTableCell>{book.flightInfo.name}</StyledTableCell>
                                            <StyledTableCell>{book.flightInfo.source}</StyledTableCell>
                                            <StyledTableCell>{book.flightInfo.destination}</StyledTableCell>
                                            <StyledTableCell>{book.flightInfo.departure}</StyledTableCell>
                                            <StyledTableCell>{book.flightInfo.arrival}</StyledTableCell>
                                            <StyledTableCell align="right">{book.flightInfo.availableSeats}</StyledTableCell>
                                            <StyledTableCell sx={{ minWidth: 55 }} align="right"><CurrencyRupeeIcon fontSize='inherit' />{book.flights.fare}</StyledTableCell>
                                            <StyledTableCell align="right">{book.createdTime}</StyledTableCell>
                                            <StyledTableCell align="right">{book.updatedTime}</StyledTableCell>
                                        </StyledTableRow>
                                    ))}
                                </TableBody>
                            </Table>
