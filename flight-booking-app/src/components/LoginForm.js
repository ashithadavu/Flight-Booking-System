...
function Login() {
    ...
    const handleSubmit = event => {
        ...
        axios.post('http://localhost:8082/authenticate', authenticationRequest)
            .then((res) => {
                console.log(res.data)
                if (inputs.username === 'admin@test.com') {
    ...
    return (
        <Box component={Paper} elevation={5} sx={{ backgroundColor: 'white', borderRadius: 2 ,width:'50%',marginTop:'7em',marginLeft:"20em"}}>
